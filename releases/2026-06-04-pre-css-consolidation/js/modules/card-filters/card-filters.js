...
function renderCardFilterControls(idPrefix, title) {
  return `
    <section class="card-filter-panel">
      ...
      <div class="card-filter-controls" data-filter-prefix="${idPrefix}">
        ...
        <label class="filter-control">
          <span>Min $</span>
          <input id="${idPrefix}FilterMinPrice" class="money-input" type="number" min="0" step="1" placeholder="0">
        </label>
        <label class="filter-control">
          <span>Max $</span>
          <input id="${idPrefix}FilterMaxPrice" class="money-input" type="number" min="0" step="1" placeholder="Any">
        </label>
