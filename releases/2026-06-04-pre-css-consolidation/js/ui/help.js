...
const helpTopics = {
  ...
  radar: {
    ...
    steps: [
      ...
      "Buying from Radar moves an idea into Positions.",
  ...
  portfolio: {
    ...
    steps: [
      ...
      "Use Sell to record a one-copy sale and log a transaction.",
  ...
  signals: {
    ...
    steps: [
      ...
      "Approaching means the current price is close to a target or the hold time is nearly due.",
      "Use No Plan quick fields to add entry, exit, and hold-month plans without leaving Signals.",
