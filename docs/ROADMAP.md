...
- [ ] Migrate Positions through the approved wrapper without changing Position business logic, then migrate Signals, Transactions, and History deliberately in Phase 2.
