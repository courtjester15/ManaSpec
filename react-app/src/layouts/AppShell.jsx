...
function HelpDrawer({ open, onClose, returnFocusRef }) {
    ...
    <main className="container">
      <header className="app-header">
        ...
        <div className="app-header-actions">
          ...
          <button ref={helpButtonRef} type="button" className="help-open-btn" onClick={() => setHelpOpen(true)}>Help</button>
        </div>
      </header>
      ...
      <HelpDrawer open={helpOpen} onClose={() => setHelpOpen(false)} returnFocusRef={helpButtonRef} />
    </main>
  );
}
