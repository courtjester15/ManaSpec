...
The active project docs now live in [docs/README.md](docs/README.md). Dated historical notes remain in `dev notes/` for reference only.

## Working Rule

Before changing code, read the relevant active spec in `docs/`. The dated `dev notes/` folder is project memory, not the current truth.
